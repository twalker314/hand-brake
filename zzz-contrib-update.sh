#!/bin/zsh
## git commit -m "contrib: update all except ffmpeg/x264+5/harfbuzz/libbluray to match master" -- contrib
## git diff --stat <branch> -- contrib/amf contrib/bzip2 contrib/fdk-aac contrib/freetype contrib/fribidi contrib/jansson contrib/lame contrib/libass contrib/libdav1d contrib/libdvdnav contrib/libdvdread contrib/libgnurx contrib/libiconv contrib/libjpeg-turbo contrib/libmfx contrib/libogg contrib/libopus contrib/libspeex contrib/libtheora contrib/libvorbis contrib/libvpl contrib/libvpx contrib/libxml2 contrib/nvenc contrib/sse2neon contrib/svt-av1 contrib/xz contrib/zimg contrib/zlib
for contrib in \
	contrib/amf \
	contrib/bzip2 \
	contrib/fdk-aac \
